    ...
    public ResultSet getSalesInfo() {
        try {
            String query = """
                    ...
                    SELECT salesinfo.salesid, salesinfo.productcode, products.productname,\s
                          salesinfo.quantity, salesinfo.revenue, customers.fullname
                   FROM salesinfo
                   INNER JOIN products ON salesinfo.productcode = products.productcode
                   INNER JOIN customers ON salesinfo.customercode =
